...
export default function LandingPage() {
  ...
  const sections = [
    {
      ...
      align: "left" as const,
      actions: [
        { label: "Sign in", variant: "primary" as const, onClick: () => openAuth("login") },
        { label: "Create account", variant: "secondary" as const, onClick: () => openAuth("register") },
      ],
    },
    {
      id: "connect",
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      <Navbar onAuthOpen={(tab) => openAuth(tab || "login")} />
      <main>
